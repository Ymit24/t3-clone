...
LlmModel.create!(name: "GPT 4o", provider: "openai", model: "openai/gpt-4o", can_search: false, can_reason: false)
LlmModel.create!(name: "GPT 4o Mini", provider: "openai", model: "openai/gpt-4o-mini", can_search: false, can_reason: false)
